...
class GeneralBusiness:
    ...
    def __str__(self) -> str:
        return 'GeneralBusiness (party_id: %s, ticker_symbol: %s, exchange_cd: %s, publish_date: %s, end_date_rep: %s, ' \
               ...
               't_liab_equity: %s)' % \
               (
                   self.party_id, self.ticker_symbol, self.exchange_cd, self.publish_date, self.end_date_rep,
                   self.end_date,
                   ...
                   self.t_ca, self.disbur_la, self.avail_for_sale_fa, self.htm_invest, self.lt_receiv,
                   ...
                   self.perpetual_bond_e, self.capital_reser, self.treasury_share, self.oth_compre_income,
                   self.special_reser,
                   self.surplus_reser,
                   self.ordin_risk_reser, self.retained_earnings, self.forex_differ, self.see, self.sea,
